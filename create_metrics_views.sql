...
WITH response_times AS (
    SELECT 
        DATE(m1.created_at) as data,
        EXTRACT(EPOCH FROM (m1.created_at - 
...
SELECT 
    ...
    AVG(rt.tempo_resposta) as tempo_medio_resposta_segundos
FROM messages m
LEFT JOIN response_times rt ON m.created_at::date = rt.data
